...
class PDGAN(BaseModel):
    def __init__(self, cfg):
        ...
        try:
            ckpt_PConvEN = torch.load('/scratch/sg7729/hpml_project/PD-GAN/2_net_EN.pth')
            ckpt_PConvDE = torch.load('/scratch/sg7729/hpml_project/PD-GAN/2_net_DE.pth')
            ...
            logger.info(
                "network {} has been defined and the pretrain model {} has been load".format(
                    "PConvEN", '/scratch/sg7729/hpml_project/PD-GAN/2_net_EN.pth'
                )
            )
            logger.info(
                "network {} has been defined and the pretrain model {} has been load".format(
                    "PConvDE", '/scratch/sg7729/hpml_project/PD-GAN/2_net_DE.pth'
                )
            )
        except:
            logger.info(
